...
NUM.beta   = 0.25;              % second-order iterative step size (reduce if not converging)
NUM.dmp    = 1;                 % damping parameter, acts as numerical bulk viscosity
NUM.minlvl = 2;                 % minimum size MG level [2^minlvl]
NUM.minlvl_tol  = 1e-4;         % residual tolerance for at minimum MG level
NUM.minlvl_smth = 2e+3;         % residual tolerance for at minimum MG level
...
PHS.f0   = [ 0.65; 0.25; 0.10]; % initial background phase fractions (unity sum!)
