...
f1 = figure(1); clf; colormap(ocean);
...
if svop
    ...
    name = ['../out/',RunID,'/',RunID,'_',num2str(step/nop)];
    save([name,'.mat'],'time','x','u','w','p','f','ustar','wstar','pstar','usegr','wsegr','pcmpt','qvxx','qvzz','qvxz','qfx','qfz','Gvx','Gvz','Gf','Kv','Kf','Cv','Cf','delta');
end